...
args = parse_args()
def build_model(vocab, tgt, dist_bar, N=6, embed_dim=512, ffn_dim=args.fnn_dim, head=4, dropout=0.1, out_both=False):
    c = copy.deepcopy
...
class Embeddings(nn.Module):    
    def __init__(self, embed_dim, vocab):
        ...
        loaded_dict = pickle.load(open('../initial/RotatE_512_256_emb.pkl', 'rb'))
