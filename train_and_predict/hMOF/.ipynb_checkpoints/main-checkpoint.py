...
def main():
    ...
    data_all_train=torch.load('/HOME/scz5707/run/hmof/hmof_train.pt')
    data_all_val=torch.load('/HOME/scz5707/run/hmof/hmof_val.pt')
    data_all_test=torch.load('/HOME/scz5707/run/hmof/hmof_test.pt')
